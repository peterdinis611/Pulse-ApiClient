...
export const THEME_DEFINITIONS: ThemeDefinition[] = [
  ...
  },
  {
    id: "sand",
    label: "Sand",
    description: "Warm beige and desert tones",
    group: "color",
    appearance: "light",
    icon: SunMedium,
    preview: { background: "#faf8f3", primary: "#b45309", accent: "#fef3c7" },
  },
  {
    id: "lavender",
    label: "Lavender",
    description: "Soft lilac and pastel purple",
    group: "color",
    appearance: "light",
    icon: Orbit,
    preview: { background: "#f8f6ff", primary: "#7c3aed", accent: "#ede9fe" },
  },
  {
    id: "citrus",
    label: "Citrus",
    description: "Fresh lime and yellow zest",
    group: "color",
    appearance: "light",
    icon: Sprout,
    preview: { background: "#f7fee7", primary: "#65a30d", accent: "#ecfccb" },
  },
  {
    id: "midnight",
    label: "Midnight",
  ...
  },
  {
    id: "aurora",
    label: "Aurora",
    description: "Northern teal and emerald glow",
    group: "color",
    appearance: "dark",
    icon: Star,
