...
export const THEME_DEFINITIONS: ThemeDefinition[] = [
  ...
  },
  {
    id: "dracula",
    label: "Dracula",
    description: "Classic purple developer theme",
    group: "color",
    appearance: "dark",
    icon: Ghost,
    preview: { background: "#282a36", primary: "#bd93f9", accent: "#44475a" },
  },
  {
    id: "coffee",
    label: "Coffee",
  ...
  },
  {
    ...
    appearance: "dark",
    icon: Aperture,
    preview: { background: "#0a0a12", primary: "#22d3ee", accent: "#1a1030" },
  },
];
