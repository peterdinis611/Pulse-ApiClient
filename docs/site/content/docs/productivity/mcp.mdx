---
title: "MCP"
description: "Cursor (and other MCP clients) can call the Pulse Rust engine over stdio — send, GraphQL, cURL, collections, bench, OpenAPI, Git workspace, contract, JUnit."
---
