...
export const FEATURE_DOC_SECTIONS: FeatureDocSection[] = [
  ...
  },
  {
    ...
    howTo: [
      ...
      "Call `http://127.0.0.1:4010/pets` for the 2xx body, or `…/pets?example=missing` / `…/pets?status=404`.",
  ...
  },
  {
    id: "mcp",
    title: "MCP",
    summary: "Cursor (and other MCP clients) can call the Pulse Rust engine over stdio — send, GraphQL, cURL, collections, bench, OpenAPI, Git workspace, contract, JUnit.",
    group: "Productivity",
    items: [
