...
export const EN_MESSAGES = {
  ...
  "onboarding.summary": "Language, theme, and how the desk opens. Change any of this later in Settings.",
...
export const SK_MESSAGES: Record<MessageKey, string> = {
  ...
  "onboarding.summary": "Jazyk, téma a ako sa otvorí stôl. Neskôr to zmeníš v Nastaveniach.",
