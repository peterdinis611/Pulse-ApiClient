...
const TOUR_STEPS: TourStepDef[] = [
  ...
  },
  {
    ...
    description: {
      en: "Serve saved 2xx examples on 127.0.0.1. Routes come from the first example on each request.",
      sk: "Uložené 2xx príklady servíruje na 127.0.0.1. Routy berie z prvého príkladu na každom requeste.",
    },
  },
  {
    view: "request",
...
export function startProductTour(ctx: ProductTourContext): void {
  ...
  const instance = driver({
    ...
    stagePadding: 8,
    stageRadius: 10,
    overlayColor: "oklch(0.18 0.02 210)",
    overlayOpacity: 0.55,
    allowClose: true,
